...
func GetDeviceCount() (int, error) { return 0, fmt.Errorf("metal not available") }

// NewContext returns an error on non-darwin platforms.
func NewContext(int) (*Context, error) { return nil, fmt.Errorf("metal not available") }

func (c *Context) Destroy() error                                    { return nil }
func (c *Context) Malloc(int) (unsafe.Pointer, error)                { return nil, fmt.Errorf("metal not available") }
func (c *Context) Free(unsafe.Pointer) error                         { return nil }
func (c *Context) Memcpy(_, _ unsafe.Pointer, _ int, _ MemcpyKind) error { return fmt.Errorf("metal not available") }
func (c *Context) CreateStream() (*Stream, error)                    { return nil, fmt.Errorf("metal not available") }
func (c *Context) Device() uintptr                                   { return 0 }
func (c *Context) Queue() uintptr                                    { return 0 }
