...
func Lib() *SYCLLib { return nil }

// SYCLLib is a stub on non-linux platforms.
type SYCLLib struct{}
...
func GetDeviceCount() (int, error) { return 0, fmt.Errorf("sycl not available") }

// NewContext returns an error on non-linux platforms.
func NewContext(int) (*Context, error) { return nil, fmt.Errorf("sycl not available") }

func (c *Context) Destroy() error                                         { return nil }
func (c *Context) Malloc(int) (unsafe.Pointer, error)                     { return nil, fmt.Errorf("sycl not available") }
func (c *Context) Free(unsafe.Pointer) error                              { return nil }
func (c *Context) Memcpy(_, _ unsafe.Pointer, _ int, _ MemcpyKind) error  { return fmt.Errorf("sycl not available") }
func (c *Context) CreateStream() (*Stream, error)                         { return nil, fmt.Errorf("sycl not available") }
