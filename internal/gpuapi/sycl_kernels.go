...
func (k *SYCLKernels) TinyBatchedGemmF32(_, _, _ unsafe.Pointer, _, _, _ int, _, _, _ int64, _ int, _ Stream) error { //nolint:gocritic // interface match
	return fmt.Errorf("TinyBatchedGemmF32: not implemented for SYCL")
}
