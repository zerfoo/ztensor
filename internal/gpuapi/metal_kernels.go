...
func (k *MetalKernels) RsqrtBF16(_, _ unsafe.Pointer, _ int, _ Stream) error {
	return fmt.Errorf("RsqrtBF16: not implemented for Metal")
}

func (k *MetalKernels) SumAxisBF16(_, _ unsafe.Pointer, _, _, _ int, _ float32, _ Stream) error {
	return fmt.Errorf("SumAxisBF16: not implemented for Metal")
}
